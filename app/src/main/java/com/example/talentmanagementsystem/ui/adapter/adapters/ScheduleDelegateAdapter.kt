...
class ScheduleDelegateAdapter: RecyclerView.Adapter<ScheduleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ScheduleViewHolder, position: Int)  =items[position].bind(holder.itemView)
